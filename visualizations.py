...
plt.bar(range(len(games)), viewers, color='orchid')
...
colors = ['lightskyblue', 'yellow', 'lightcoral', 'r', 'royalblue', 'deeppink', 'darkseagreen', 'sienna', 'darkolivegreen', 'gold', 'violet', 'limegreen']
